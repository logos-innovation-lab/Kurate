...
task("deploy", "Deploy a GlobalAnonymousFeed contract")
  ...
  .setAction(async ({ logs, unirep: unirepAddress }, { ethers, run }) => {
    ...
    // const estimatedGas = await globalAnonymousFeedFactory.signer.estimateGas(globalAnonymousFeedFactory.getDeployTransaction('0x6354F74F29982190B0a830Ac46E279B03d5e169c', 28800));
    ...
    // const globalAnonymousFeedContract = await globalAnonymousFeedFactory.deploy('0x6354F74F29982190B0a830Ac46E279B03d5e169c', 28800);
