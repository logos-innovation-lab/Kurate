...
describe("Global Anonymous Feed Contract", () => {
    ...
    describe("Global Anonymous Feed Contract", () => {
        ...
        it('should seal epoch with new attestations', async () => {
            // const remainingTime = (await postContract.attesterEpochRemainingTime()).toNumber();
        ...
        it("Should allow users to propose a comment", async () => {
            ...
            const repProofs = await state.genProveReputationProof({ minRep: 3 });
        ...
        it("Should tally vote", async () => {
            ...
            //     const epochKey = BigInt('19360822832641327982030620568535301882136199576641632892778591705924470381589');
            //     let totalRep = 100;
            //     const fieldIndex = 0;
            //     preimages.push([
            //         epochKey,
            ...
            //
            // await postContract.sealEpoch(72, bot.publicSignals, bot.proof, { gasLimit: 6721974 })
